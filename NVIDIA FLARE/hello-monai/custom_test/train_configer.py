...
from monai.data import CacheDataset, DataLoader, load_decathlon_datalist, pad_list_data_collate # TODO: import pad_list_data_collate
...
class TrainConfiger:
    ...
    def __init__(
        ...
        # TODO: change dataset_folder_name
        dataset_folder_name: str = "Task02_Heart",     # "Task09_Spleen"
        max_epochs: int = 100,
    ):
    ...
    def configure(self):
        ...
        self.eval_engine = SupervisedEvaluator(
            ...
            inferer=SlidingWindowInferer(
                roi_size=[80, 80, 80], # TODO: change. original: (160, 160, 160)
                sw_batch_size=4,
                overlap=0.5,
            ),
